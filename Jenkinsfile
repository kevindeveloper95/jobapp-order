...
pipeline {
  ...
  environment {
    ...
    IMAGE_NAME = "kevin1208" + "/" + "jobber-order"
  ...
  stages {
    ...
    stage("Prepare Environment") {
      steps {
        ...
        // Add your order service url to url field
        git branch: 'master', credentialsId: 'github', url: 'https://github.com/kevindeveloper95/jobapp-order'
        script {
